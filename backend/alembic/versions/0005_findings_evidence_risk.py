...
down_revision: Union[str, None] = "0004_tasks_and_dependencies"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("evidence_type", sa.String(length=32), nullable=False, server_default="RAW_OUTPUT"),
    ...
    op.create_table(
        "risk_scores",
        sa.Column("id", sa.String(length=64), primary_key=True),
        sa.Column("finding_id", sa.String(length=64), sa.ForeignKey("findings.id", ondelete="CASCADE"), nullable=False, unique=True),
        ...
        sa.Column("privileges_required", sa.String(length=32), nullable=False, server_default="NONE"),
        ...
        sa.Column("confidentiality_impact", sa.String(length=32), nullable=False, server_default="HIGH"),
        sa.Column("integrity_impact", sa.String(length=32), nullable=False, server_default="NONE"),
        sa.Column("availability_impact", sa.String(length=32), nullable=False, server_default="NONE"),
        sa.Column("created_at", sa.String(length=64), nullable=False),
    )
